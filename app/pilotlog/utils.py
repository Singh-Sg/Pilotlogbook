...
def import_data(file_path):
    ...
    for item in data:
        ...
        try:
            ...
            datetime_fields = {field.name: field for field in ModelClass._meta.fields if isinstance(field, models.DateTimeField)}
            ...
            for field_name, value in item.items():
                if field_name in datetime_fields and isinstance(value, int):
                    ...
                    value = timezone.make_aware(naive_dt, timezone.get_current_timezone())
            ...
            for field_name, value in meta_data.items():
                ...
                field_name = field_name if hasattr(ModelClass, field_name) else field_name.lower()
                try:
